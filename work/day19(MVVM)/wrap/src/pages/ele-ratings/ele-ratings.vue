            ...
            <div class="overview">
                ...
                <div class="overview-right">
                    <div class="score-wrapper">
                        ...
                        <ele-star class="star" size="36" :mr="3"
                                  :score="seller.serviceScore"></ele-star>
                        <span class="score">{{seller.serviceScore}}</span>
                    </div>
                    <div class="score-wrapper">
                        <span class="title">商品评分</span>
                        <ele-star class="star" size="36" :mr="3"
                                  :score="seller.foodScore"></ele-star>
                    ...
                    <li class="rating-item" v-for="(rating,index) in filterRatings" :key="index">
                        ...
                        <div class="content">
                            ...
                            <div class="star-wrapper">
                                <ele-star size="24" class="star" :score="rating.score" :mr="1"></ele-star>
...
<script>
    ...
    export default {
        ...
        data(){
          return {
              type:0,   // type:需要查看的评价的类型.   2:全部  ; 0:推荐 ; 1:吐槽
              hasText:false //onlyText:查看的评价是否需要携带内容 true:必须拥有内容  ; false:不要求有内容
          }
        },
        computed:{
