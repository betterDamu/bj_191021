                            ...
                            <div class="shop_right">
                                ...
                                <section class="shop_rating_order">
                                    <section class="shop_rating_order_left">
                                        <ele-stars class="stars" :mr="2" size="24" :score="shop.rating"></ele-stars>
                                    ...
                                    <section class="shop_rating_order_right">
                                        <span class="delivery_style delivery_left" v-if="shop.delivery_mode">
...
<script>
    import {GETADDRESSS,GETCATEGORIES,GETSHOPS} from "store/mutation_types"
    ...
    export default {
        ...
        methods:{
            ...mapActions([GETADDRESSS,GETCATEGORIES,GETSHOPS]),
            renderSwiper(){
                this.$nextTick(()=>{
